...
class EwayPaymentGateWay {
	...
	private function makeBookingAndCompletePayment( $response ) {
		//https://www.nx.jtbtravel.com.au/payment/failed/
...
*/
		...
		if(isset($_SESSION['email2'])) {
			...
			add_filter( 'wp_mail_content_type', 'wpdocs_set_html_mail_content_type' );
		   	wp_mail( $email2,"JTB Australia Payment - ".$lastname . " - " .$invoice,"Thank you for your payment to JTB Australia. Your payment was successful.<br /><br />Customer Name: ".$name ." ".$lastname."<br />Amount: $".$amnt."<br />Invoice Reference: ".$invoice."<br />Customer Email: ".$email2 ."<br />State: ".$_SESSION['state2']."<br />Contact number: ".$_SESSION['phoneno2'] . "<br /><br /> <img src=\"https://www.nx.jtbtravel.com.au/wp-content/uploads/2017/03/jtb-logo-email.png\" style=\"width:125px;height:auto;\" /><p style=\" font-size: 1.4em;font-weight:bold;padding:0;margin:0;\">JTB Australia Pty Ltd</p><p style=\"padding:0;margin:0;\"><strong>Toll Free: 1300 739 330</strong></p><p style=\"padding:0;margin:0;\">License No: 02361295 IATA No: 02361295 ABN: 99 003 218 728</p><br />Transaction: ". $status ." " . $code ." " .  $ewayref, "From: JTB Australia <sydres@nx.jtbtravel.com.au>\r\nReply-To: ".$jtbemail  );
		   	remove_filter( 'wp_mail_content_type', 'wpdocs_set_html_mail_content_type' );
		}
		//wp_mail( $jtbemail,"Offline Payment Received - ".$lastname . " - " .$invoice, "An offline payment has been received through eWay.\r\n\r\nCustomer Name: ".$name ." ".$lastname."\r\nAmount: $".$amnt."\r\nInvoice Reference: ".$invoice."\r\nCustomer Email: ".$email2 ."\r\nState: ".$_SESSION['state2'] ."\r\nContact number: ".$_SESSION['phoneno2'] , "From: JTB Australia <sydres@nx.jtbtravel.com.au>\r\nReply-To: ". $email2 ."\r\nCc: webmaster.au@jtbap.com" );
		//wp_mail( "accounts.au@jtbap.com","JTB Australia Payment - ".$lastname . " - " .$invoice,"New offline payment - nx.jtbtravel.com.au\r\n\r\nCustomer Name: ".$name ." ".$lastname."\r\nAmount: $".$amnt."\r\nInvoice Reference: ".$invoice."\r\nCustomer Email: ".$email2 ."\r\nState: ".$_SESSION['state2']."\r\nContact number: ".$_SESSION['phoneno2'], "From: JTB Australia <sydres@nx.jtbtravel.com.au>\r\nReply-To: ".$jtbemail  );
	...
	private function redirectToSharedPaymentUrl() {
	    $data = '';
        $data = $data . '<LogoUrl>https://www.nx.jtbtravel.com.au/wp-content/uploads/2017/02/JTB-perfect-moments-offline.jpg</LogoUrl>' 	;
