	...
	<div class="row tours2"> 
		...
		<?php
		    ...
		    while ( have_rows('tour_item') ) : the_row();
		    	$tempid = url_to_postid( get_sub_field('url') );
		    	$urltemp= get_sub_field('text_url');
				if (get_post_meta($tempid, '_hide_from_search', true)=="1"){
					continue;
				}else if(($urltemp == "hidden") || ($urltemp == "Hidden")){
					continue;
				}
				...
				<div class="col-xs-12 col-sm-6">
					<div class="thumbnail">
						...
						$img11 = $imgtemp['url'];
						if(get_sub_field('textimage')){
								$img11=get_sub_field('textimage');
						}
						if ($img11 == ''){
