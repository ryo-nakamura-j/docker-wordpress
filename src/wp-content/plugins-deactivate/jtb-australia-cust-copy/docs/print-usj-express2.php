...
<input name='consultant_name' id='consultant_name' required>
</div>
</div>
...
<input name='consultant_name2' id='consultant_name2' required>
</div>
</div>
...
<h2>Select your USJ Express Pass Type</h2><!--#2-->
...
<br /><br />
<p id="date_limit_text3">*Tickets are only available for request up until <span id="date_limit_text"></span></p>
...
if(current_user_can('edit_post')){
  echo '<p class="yellow-message">You are logged in as admin - to update prices and labels on this form - edit this wordpress page.</p>';
}
