...
<div id="flightbox" > 
<h2><i class="fa fa-plane" aria-hidden="true"></i> Flight Search</h2>
...
<h4>We do not charge credit card fees</h4>
...
<div class="left">
  <span class="left">
    <input name="returnOrOneWay" value="R" checked="checked" type="radio"><strong>Return</strong></span><span  class="left">
    <input name="returnOrOneWay" value="O" type="radio"><strong>One Way</strong>
  </span>
</div>
</div>
...
<div class="row">
<div class="left">
<span><strong>Cabin Class</strong></span></div><div class="left">
...
<?php
$sydneypages = array('20547','20548','20548','21220','21217','21238','21236','21234','21232','21230','21228','21226','21223','21222');
if(  in_array(get_the_ID(), $sydneypages)){
 	echo '<option value="SYD">Sydney (SYD), Australia - Kingsford Smith</option>';
}else if(get_the_ID()==20549){
	echo '<option value="MEL">Melbourne (MEL), Australia - Melbourne Airport</option>';
}else if(get_the_ID()==20550){
	echo '<option value="BNE">Brisbane (BNE), Australia - Brisbane</option>';
}else if(get_the_ID()==20551){
	echo '<option value="ADL">Adelaide (ADL), Australia - Adelaide</option>';
}else if(get_the_ID()==20552){
	echo '<option value="PER">Perth (PER), Australia - Perth</option>';
}else if(get_the_ID()==20553){
	echo '<option value="CBR">Canberra (CBR), Australia - Canberra</option>';
}
?>
...
<div class="left">
	<span>
		<input id="searchAir.segments0.arrivalCity" name="searchAir.segments[0].arrivalCity" type="text" class="airport-autocomplete explore-validate-airport" value="<?php
if( (get_the_ID()==20547) ){
 	echo 'Tokyo (NRT)';
}else if((get_the_ID()==20548)){
	echo 'Tokyo (HND)';
}else if( (get_the_ID()==20549)||(get_the_ID()==20550)||(get_the_ID()==20551)||(get_the_ID()==20552)||(get_the_ID()==20553) ){
	echo 'Tokyo (TYO)';
}else if(get_the_ID()==21220){
  echo 'Osaka (OSA)';
}else if(get_the_ID()==21222){
  echo 'Sapporo (SPK)';
}else if(get_the_ID()==21223){
  echo 'Nagoya (NGO)';
}else if(get_the_ID()==21226){
  echo 'Fukuoka (FUK)';
}else if(get_the_ID()==21228){
  echo 'Okinawa (OKA)';
}else if(get_the_ID()==21230){
  echo 'Hiroshima (HIJ)';
}else if(get_the_ID()==21232){
  echo 'Sendai (SDJ)';
}
?>">
	</span>
...
<?php if((get_the_ID()!=21234)&&(get_the_ID()!=21236)&&(get_the_ID()!=21238)){
  echo '<p><strong>Preferred Airlines</strong><p/>';
}
 ?>


      <div class="col-xs-12 col-sm-4">
				<input name="searchAir.carriers[0]" id="carriers0" <?php if((get_the_ID()==21234)||(get_the_ID()==21236)||(get_the_ID()==21238)){echo 'type="hidden"';}else{echo 'type="text"';} ?> <?php if(get_the_ID()==21234){echo 'value="Japan Airlines (JL)"';}else if(get_the_ID()==21236){echo 'value="Qantas (QF)"';}else if(get_the_ID()==21238){echo 'value="All Nippon Airways (NH)"';} ?> >
      </div>
      <div class="col-xs-12 col-sm-4">
				<input name="searchAir.carriers[1]" id="carriers1" <?php if((get_the_ID()==21234)||(get_the_ID()==21236)||(get_the_ID()==21238)){echo 'type="hidden"';}else{echo 'type="text"';} ?> <?php if(get_the_ID()==21234){echo 'value="JAL Express (JC)"';} ?> >
      </div>
      <div class="col-xs-12 col-sm-4">
				<input name="searchAir.carriers[2]" id="carriers2" <?php if((get_the_ID()==21234)||(get_the_ID()==21236)||(get_the_ID()==21238)){echo 'type="hidden"';}else{echo 'type="text"';} ?> <?php if(get_the_ID()==21234){echo 'value="JALways Co Ltd (JO)"';} ?> >
      </div>
<hr />
