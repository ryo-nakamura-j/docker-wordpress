        ...
        <script>
            jQuery(function ($) {
                $('body').on('click', '#attachsf', function (e) {
                    ...
                    $(window.parent.document.body).append("<iframe id='wpdm-asset-picker' style='left:0;top:0;width: 100%;height: 100%;z-index: 999999999;position: fixed;background: rgba(255,255,255,0.4) url('<?php echo WPDM_ASSET_URL.'images/loader.svg'; ?>') center center no-repeat;background-size: 100px 100px;border: 0;' src='<?php echo admin_url('/index.php?assetpicker=1'); ?>'></iframe>");
