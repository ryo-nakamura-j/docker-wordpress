...
<div id="package-settings" class="tab-pane active">
    <table cellpadding="5" id="file_settings_table" cellspacing="0" width="100%" class="table table-bordered table-hover">
        ...
        <tr id="view_count_row">
            ...
            <td><input size="10" style="width: 80px" type="number" class="form-control input-sm" name="file[view_count]" value="<?php echo esc_attr(get_post_meta($post->ID,'__wpdm_view_count',true)); ?>" /> <i class="info fa-solid fa-circle-question" title="Set/Reset Download Count for this package"></i></td>
        </tr>

       <tr id="download_count_row">
            <td><?php echo __( "Download&nbsp;Count:" , "download-manager" ); ?></td>
            <td><input size="10" style="width: 80px" type="number" class="form-control input-sm" name="file[download_count]" value="<?php echo esc_attr(get_post_meta($post->ID,'__wpdm_download_count',true)); ?>" /> <i class="info fa-solid fa-circle-question" title="Set/Reset Download Count for this package"></i></td>
        </tr>

       <tr id="package_size_row">
            <td><?php echo __( "Package&nbsp;Size:" , "download-manager" ); ?></td>
            <td><input size="10" style="width: 80px" class="form-control input-sm" type="text" name="file[package_size]" value="<?php echo esc_attr(get_post_meta($post->ID,'__wpdm_package_size',true)); ?>" /> <i class="info fa-solid fa-circle-question" title="Total size of included files with this package."></i></td>
        </tr>
        ...
        <?php if(isset($_GET['post'])&&$_GET['post']!=''){ ?>
            <tr>
                ...
                <td><input class="form-control" style="font-family: monospace;letter-spacing: 1px" type="text" readonly="readonly" value="<?php echo get_post_meta($post->ID, '__wpdm_masterkey', true); ?>">
                    <div class="mt-1">
                        <label class="fw-4"><input type="checkbox" value="1" name="reset_key" /> <?php echo __( "Regenerate Master Key for Download" , "download-manager" ); ?></label> <i class="info fa-solid fa-circle-question" data-placement="top" title="<?php echo __( "This key can be used for direct download" , "download-manager" ); ?>"></i>
                    </div>
                </td>
            </tr>
        <?php } ?>
