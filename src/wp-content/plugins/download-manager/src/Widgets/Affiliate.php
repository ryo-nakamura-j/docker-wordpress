...
if (!class_exists('WPDM_Affiliate')) {
    class WPDM_Affiliate extends WP_Widget
    {
        ...
        function widget($args, $instance)
        {
            ...
            echo "<div class='panel-footer' style='line-height: 30px'><a class='pull-right btn btn-sm btn-danger' href='https://www.wpdownloadmanager.com/?affid={$title}'>Buy Now <i class='fa fa-angle-right'></i></a><span class='label label-success' style='font-size: 12pt;border-radius: 2px'>$99.00</span></div></div></div>";
            echo $after_widget;
        }
