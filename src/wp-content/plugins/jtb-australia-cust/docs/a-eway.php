...
if( (strlen($name)<1)|| (strlen($email)<1)||(strlen($refno)<1)||(strlen($amount)<1) ){
...
if (($state2==false)||($state2==null)||($state2=="x")){
	$errormessage .= "<p>Please select your state of residence.</p>";
}
if(strlen($phoneno)<4){
	$errormessage .= "<p>Please enter a contact number.</p>";
}
...
//$amount = (int)$amount;
$amount =  (int)(2/100*floatval($amount)+floatval($amount) );
$_POST["amount"]=$amount;
...
class EwayPaymentGateWay2 {
	...
	function __construct() {
		...
		$this->redirectUrl = 'https://www.nx.jtbtravel.com.au/wp-content/plugins/jtb-australia-cust/docs/a-eway.php';
	...
	public function processingRedirect() {
		// Get AccessCode
		if(isset($_GET["AccessCode"])){$AccessCode = $_GET["AccessCode"];}
	...
	private function makeBookingAndCompletePayment( $response ) {
		...
		preg_match_all('{<FraudAction.*?</}',$response,$challenge2);
...
*/
		...
		$challenge = $challenge2[0][0];
		$challengeoriginal = $challenge;
		$challenge = str_replace("<FraudAction>", "", str_replace("</", "", $code));
		...
		if(isset($_SESSION['state2'])) {
			if(($_SESSION['state2']=="VIC")||($_SESSION['agent']=="agent")){
		...
		$jtbemail="onlinereservations@nx.jtbtravel.com.au";
...
if(($challenge=="Review")||($challenge=="Block")|| ($challenge!="08" && $challenge!="08 " && $challenge!="00") ){ //eway challenge - email KATE (BEN)
	wp_mail( "benjamin_g.au@jtbap.com","eWay Challenge/ Review/ Block - ".$lastname . " - " .$invoice,"EWAY ERROR MESSAGE - - Challenge-message: ".$challengeoriginal."<br /><br />Transaction ID: ".   $ewayref . "<br /><br />Customer Name: ".$name ." ".$lastname."<br />Amount: $".$amnt."<br />Invoice Reference: ".$invoice."<br /><br />Customer Email: ".$email2 ."<br />State: ".$_SESSION['state2']."<br />Contact number: ".$_SESSION['phoneno2'] . "<br /><br /><br /> <img src=\"https://www.nx.jtbtravel.com.au/wp-content/uploads/2017/08/jtb-logo-email.png\" style=\"width:125px;height:auto;\" /> ", "From: JTB Australia <sydres@nx.jtbtravel.com.au>\r\n\Cc: webmaster.au@jtbap.com\r\nReply-To: benjamin_g.au@jtbap.com" ); 
}


wp_mail( $email2,"JTB Australia Payment - ".$lastname . " - " .$invoice,"Thank you for your payment to JTB Australia. Your payment was successful.<br /><br />Transaction ID: ".   $ewayref . "<br /><br />Customer Name: ".$name ." ".$lastname."<br />Amount: $".$amnt."<br />Invoice Reference: ".$invoice."<br /><br />Customer Email: ".$email2 ."<br />State: ".$_SESSION['state2']."<br />Contact number: ".$_SESSION['phoneno2'] . "<br /><br /><br /> <img src=\"https://www.nx.jtbtravel.com.au/wp-content/uploads/2017/08/jtb-logo-email.png\" style=\"width:125px;height:auto;\" /><p style=\" font-size: 1.4em;font-weight:bold;padding:0;margin:0;\">JTB Australia Pty Ltd</p><p style=\"padding:0;margin:0;\"><strong>Toll Free: 1300 739 330</strong></p><p style=\"padding:0;margin:0;\">License No: 02361295 IATA No: 02361295 ABN: 99 003 218 728</p>", "From: JTB Australia <sydres@nx.jtbtravel.com.au>\r\nReply-To: ".$jtbemail  );
	remove_filter( 'wp_mail_content_type', 'wpdocs_set_html_mail_content_type' );
}

add_filter( 'wp_mail_content_type', 'wpdocs_set_html_mail_content_type' );
wp_mail( $jtbemail,"Offline Payment Received - ".$lastname . " - " .$invoice, "<img src=\"https://www.nx.jtbtravel.com.au/wp-content/uploads/2017/10/admin-section.png\" style=\"position:relative;float:right;display:inline-block;width:100px;height:auto;\" />An offline payment has been received through eWay.<br /><br /><b>Transaction ID:</b> ".$ewayref."<br /><br /><b>Customer Name:</b> ".$name ." ".$lastname."<br /><b>Amount:</b> $".$amnt."<br /><b>Invoice Reference:</b> ".$invoice."<br /><br /><b>Customer Email:</b> ".$email2 ."<br /><b>State:</b> ".$_SESSION['state2'] ."<br /><b>Contact number:</b> ".$_SESSION['phoneno2']   , "From: JTB Australia <sydres@nx.jtbtravel.com.au>\r\nReply-To: ". $email2 );

wp_mail( "webmaster.au@jtbap.com","Offline Payment Received - ".$lastname . " - " .$invoice, "<img src=\"https://www.nx.jtbtravel.com.au/wp-content/uploads/2017/10/admin-section.png\" style=\"position:relative;float:right;display:inline-block;width:100px;height:auto;\" />An offline payment has been received through eWay.<br /><br /><b>Transaction ID:</b> ".$ewayref."<br /><br /><b>Customer Name:</b> ".$name ." ".$lastname."<br /><b>Amount:</b> $".$amnt."<br /><b>Invoice Reference:</b> ".$invoice."<br /><br /><b>Customer Email:</b> ".$email2 ."<br /><b>State:</b> ".$_SESSION['state2'] ."<br /><b>Contact number:</b> ".$_SESSION['phoneno2'] ."<br /><br /><b>Status Message:</b> ".  $statusmessage ."<br /><b>FRAUD MESSAGE:</b> ".$challenge , "From: JTB Australia <sydres@nx.jtbtravel.com.au>\r\nReply-To: ". $email2 );

wp_mail( "accounts.au@jtbap.com","JTB Australia Payment - ".$lastname . " - " .$invoice,"<img src=\"https://www.nx.jtbtravel.com.au/wp-content/uploads/2017/10/admin-section.png\" style=\"position:relative;float:right;display:inline-block;width:100px;height:auto;\" />New offline payment - nx.jtbtravel.com.au<br /><br /><b>Transaction ID:</b> ".$ewayref."<br /><br /><b>Customer Name:</b> ".$name ." ".$lastname."<br /><b>Amount:</b> $".$amnt."<br /><b>Invoice Reference:</b> ".$invoice."<br /><br /><b>Customer Email:</b> ".$email2 ."<br /><b>State:</b> ".$_SESSION['state2'] ."<br /><b>Contact number:</b> ".$_SESSION['phoneno2']  , "From: JTB Australia <sydres@nx.jtbtravel.com.au>\r\nReply-To: ".$jtbemail  );
	...
	private function redirectToSharedPaymentUrl() {
	    $data = '';
        $data = $data . '<LogoUrl>https://www.nx.jtbtravel.com.au/wp-content/uploads/2017/02/jtb-cc.jpg</LogoUrl>' 	;
        ...
        $data = $data
		    	...
		    	//  . '<TokenCustomerID>'		. get_option('tp_eway_customer')					. '</TokenCustomerID>'
		    		...
		    		. '<Street1>'.$_POST["street"].'</Street1>'
		    		. '<Street2></Street2>'
		    		. '<City>'.$_POST["city"].'</City>'
		    		. '<State>'.$_POST["your-recipient7"].'</State>'
		    		. '<PostalCode>'.$_POST["postcode"].'</PostalCode>'
		    		. '<Country>AU</Country>'
		    	. '</Customer>'
		    	. '<Payment>'
		    		...
		    		. '<InvoiceDescription>OfflineBooking-' .date("Y-m-d")  ."-" . $_POST["refno"]
					. '</InvoiceDescription>'
		    	...
		    	. '<Options>'
		    		...
		    		. '</Option>'
		    		. '<Option>'
		    			. '<Value>'				. 'IPaddr ' .    $_SERVER['REMOTE_ADDR']		. '</Value>'
		    		. '</Option>'
		    	. '</Options>';
	...
	{
		//LIVE 
		//return 'C3AB9AHnI8edeP1S3X98sTV+4e4pKFVgyfpThYESFrcnjXbe5u5Sa4+C7CjpEsRnuNWnVw:mn0311JTB'; 
		
		//epk-AADFB703-E6DE-48BD-BC0F-A67DFCC3C319
		//F9802ARtqzU6nzD99W1SWEbNXieaoYu9/nM7y5a8KSqY6LgFXdZ/BVNQ2C1S+mWhUvqwyF
		//return 'F9802ARtqzU6nzD99W1SWEbNXieaoYu9/nM7y5a8KSqY6LgFXdZ/BVNQ2C1S+mWhUvqwyF';
		
		//return 'F9802ARtqzU6nzD99W1SWEbNXieaoYu9/nM7y5a8KSqY6LgFXdZ/BVNQ2C1S+mWhUvqwyF:lFER5aAB';
		
		
		return 'C3AB9AXjMkwbIOSh5zjFpHrsLyFsOhjmCYV//lEdvdXCvGOnOQ6smqmcpUoXRvnK3ZEl4n:G7GCSbsWjM5q';




		//https://www.nx.jtbtravel.com.au/?payment=canceled%2F%3Ferror%3D
		//PaymentAuthFailed%3
		//ANoresponsedetected.
		//EwayAPIusernameandpasswordmaynotmatch.
