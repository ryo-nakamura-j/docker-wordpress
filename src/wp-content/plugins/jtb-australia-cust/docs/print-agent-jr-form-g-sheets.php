...
if(  current_user_can( 'edit_post' )   ) {
  ...
  echo '<br /><br /><strong>JTB_IP:</strong> 220.233.230.170<br /><br />';
?>
...
<ul>
<li>Address: Level 6, 31 Queen Street
</li></ul>
...
<li>Address: Level 18, 456 Kent Street (Town Hall House)
 ...
 <span class="same_pass"> <input type="radio" name="delivery_method" value="Dx_mail" class="agent_form_radio"  ><p>TOLL DX MAIL / EXPRESS POST (FREE)</p></span>

<ul><li>Allow up to 5 working days for delivery.</li>
<li>Delivery directly to clients is not available.</li>
<li>JTB is not liable for lost or misplaced passes</li>
</ul>
...
<ul>
</li><li>After purchase and voucher issuance, a re-issue fee of $45 per change will apply for any name correction (This applies to corrections only. Completely different names will be treated as a cancellation), plus any delivery and credit card surcharges will apply ($8.50 Toll Express Mail, $21 Courier). You must send the original exchange coupon back to the office of purchase.</li><li>
The downgrading of a JR pass (same name), after purchase will also attract a $45 re issue fee plus any delivery fees.</li><li>
Neither an exchange coupon nor a Japan Rail Pass can be reissued if lost or stolen.</li><li>
An exchange coupon can be refunded within 1 year of purchase. A 20% cancellation fee will be charged PLUS a non refundable deposit of $110 per person which can be held in credit for 12 months. Any credit card surcharge is non refundable. Please note that if you have exchanged the Pass in Japan, the ticket is non-changeable and non-refundable.</li><li>
