...
<?php  $counter=0; $post_id = get_the_ID(); wp_reset_query() ; the_post(6170); ?>

<div class="col-sm-12">
	<div class="jrpass-bookingflow thumbnail">
	<?php  
	// check if the repeater field has rows of data
	if( have_rows('regional_rail_pass_section', 6170) ):

	 	// loop through the rows of data
	    while ( have_rows('regional_rail_pass_section', 6170) ) : the_row();
		//if current item == current page - skip


$title = get_sub_field('rail_pass_name', 6170);
$titlelower = strtolower(get_sub_field('rail_pass_name', 6170));
if ($post_id==3347){
...
$counter +=1;
	?>
	  ...
	  <div class="col-sm-3">
		<div class="single">
		<img class="img-responsive" src="<?php the_sub_field('rail_pass_map', 6170) ?>" alt="..."><?php if ($counter<4){ ?><i class="fa fa fa-arrow-right icon" aria-hidden="true" ></i><i class="fa fa-arrow-down iconmob" aria-hidden="true"></i><?php } ?>
	...
	?><div class='clear'></div>
 	<div class="page-top">
		<p><a class="button"  target="_blank" href="https://www.nx.jtbtravel.com.au/wp-admin/post.php?post=6170&action=edit">Edit chart</a></p>
	</div>
	<?php } ?>
