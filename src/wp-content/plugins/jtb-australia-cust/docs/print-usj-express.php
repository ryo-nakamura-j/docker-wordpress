...
// Change date cutoff fixed date to ofset 2 month 
//||||||||| search for this 
...
//change from random select date cut off for USJ_Express 
// to - 2 months from today - 61 days 
// 5270400 seconds
$cutoffdate = get_option("jtbau_usj_date") ; 
//original

//raw data field 3IMG - 20231227 YYYYMMDD
//"THE 27th of DECEMBER 2023"
//$cutoffdate = ;

// when saving - it makes it text. 
//on the print - get unix time + 2month, set to text MONTH of the DAY etc.
// message needs to be added to the wizywig section above the form 
//form validation update JS?
...
<?php /*onchange="changedate2()"*/ ?>
<input type="hidden" name="hiddenxdata" id="hidden_date_data" value='25th of DECEMBER 2099' /><?php // no validate - 2 month message - to do ?>
...
<p id="date_limit_text3">*Express Passes can only be requested 2 months from today’s date!</p> <?php 
/*
echo $cutoffdate;
...
<p class="inputwidth"><strong>Express Passes are only valid on the day obtained. (It is only valid for the date printed on the ticket)
If you require 2 day studio entry ticket (admission ticket), you may need to select 2 Express Passes for each day.</strong></p>
...
/*new addition - loop each twice for EXPRESS + 1 day or 2 day ticket*/
$countloop = 1;
...
while($countloop < 3 ){
      ...
      ?>
        <input type="radio" class="checkbox-usj" name="pass_3_1"  id="pass_2_<?php echo $pas_no; ?>_<?php echo $countloop; ?>"  value="<?php echo $pass_name_nospace ; ?>-+-<?php echo $countloop; ?>-Day-USJ-admission-ticket"> <?php echo $capt ; ?>  + <?php echo $countloop; ?> Day USJ admission ticket <br>
      <?php
