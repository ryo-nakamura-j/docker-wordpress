	...
	$('#date_limit_text3').removeClass('red-text');
		...
		if(date_using_unix > date_before_unix){
			...
			if(date_using_unix < ts){//if date before today - error
				...
				document.getElementById("jr_use_date").value = d1 + "/" + m1 + "/" + y1  ;
				$('#date_limit_text3').removeClass('red-text');
			}
...
$("#date_limit_text" ).html($('#availabledates2').val());
}
...
for (var i = 0 ; i <= nopasses; i++) {
	...
	}else if($('#consultant_name2').val() === '') {
	    cvf_form_validate($('#consultant_name2'));
	    console.log('Required: consultant_surname');
	}else if($('#suburb').val() === '') {
...
var consultant_name =  jQuery('#consultant_name').val() +" "+ jQuery('#consultant_name2').val();
...
message += "[[h2]]USJ Express Pass Request Form:[[/h2]]";
message += "[[b]]Name:[[/b]][[br /]]"+consultant_name.toUpperCase()+"[[br /]]";
message += "[[b]]Email:[[/b]][[br /]]"+email+"[[br /]]";
message += "[[b]]Phone:[[/b]][[br /]]"+agent_tel+"[[br /]]";
message += "[[b]]Address (Australia only):[[/b]][[br /]]"+address1.toUpperCase()+"[[br /]]";
...
message += "[[h2]]Request Details[[/h2]]";

message += "[[b]]Order transaction time:[[/b]][[br /]]@@#DATE_TIME#@@[[br /]]";
message += "[[b]]Date of departure from Australia:[[/b]][[br /]]"+departure_date+"[[br /]]";
message += "[[b]]Intended date of entry:[[/b]][[br /]]"+jr_use_date+"[[br /]]";


message += "[[h2]]Pass Details[[/h2]]"  ;
message +=  "[[b]]Pass: [[/b]]" +passlist + "[[br /]][[b]]Number of days: [[/b]]"+numberofdays2 +"[[br /]]" ;
if( tix_booked2.length >0 ){
   message +=  "[[b]]Booked entry ticket?[[/b]] - " + tix_booked2 + "[[br /]]" ;
}
