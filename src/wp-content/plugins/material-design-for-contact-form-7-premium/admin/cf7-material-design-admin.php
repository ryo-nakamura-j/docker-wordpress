...
class CF7_Material_Design_Admin {
    ...
    public function add_scripts_and_styles( $hook ) {
        ...
        wp_enqueue_script( 'cf7-material-design-bundle', plugins_url( '../assets/js/cf7-material-design-bundle.js', __FILE__ ), array('jquery'), '1.0', true );
        ...
        wp_register_script( 'cf7-material-design-admin', plugins_url( '../assets/js/cf7-material-design-admin.js', __FILE__ ), array( 'jquery', 'cf7md-slick', 'nouislider', 'clipboard' ), '1.1', true );
		...
		wp_register_style( 'cf7md-material-icons', '//fonts.googleapis.com/icon?family=Material+Icons', array(), null );
				...
				<div class="cf7md-scg">
					<div class="cf7md-scg--header">
						<a href="#" class="cf7md-modal-close-btn">
							...
							<div class="screen-reader-text"><?php /* translators: close as in exit */ _e( 'Close', 'material-design-for-contact-form-7' ); ?></div>
						</a>
						<a href="#" class="cf7md-modal-back-btn">
							<div class="dashicons-before dashicons-arrow-left-alt"></div>
							<div class="screen-reader-text"><?php _e( 'Back', 'material-design-for-contact-form-7' ); ?></div>
						</a>
						<h3 class="cf7md-scg--title"><?php /* translators: %s: "Material Design" */ printf( __( '%s Shortcode Generator', 'material-design-for-contact-form-7' ), 'Material Design' ); ?></h3>
					</div>
					<div class="cf7md-scg--body">
						<div class="cf7md-scg--list-panel" data-panel="list">
							<h3 class="mdc-list-group__subheader"><?php _e( 'Choose a shortcode to generate', 'material-design-for-contact-form-7' ); ?></h3>
								...
								<?php foreach( $this->scg_state['shortcodes'] as $sc ) : ?>
									...
									?>
										<span class="mdc-list-item__text">
											<span class="mdc-list-item__primary-text"><?php echo $sc['name']; ?>
												<?php echo $locked ? ' (' . __( 'Pro feature', 'material-design-for-contact-form-7' ) . ')' : ''; ?>
											</span>
											<span class="mdc-list-item__secondary-text"><?php echo $sc['description']; ?></span>
										</span>
										<?php if( $locked ) : ?>
											<a class="cf7md-list-item--upgrade-btn mdc-button" data-mdc-auto-init="MDCRipple" href="<?php echo $this->upgrade_url; ?>"><?php _e( 'Upgrade Now', 'material-design-for-contact-form-7' ); ?></a>
										<?php endif; ?>
									<?php echo $closeTag; ?>
								<?php endforeach; ?>
							</nav>
								...
								<div class="cf7md-scg--panel" data-panel="<?php echo esc_attr($sc['type']); ?>" style="display: none;">
									...
									<div class="cf7md-scg--footer">
										...
										<div class="cf7md-scg--footer-buttons">
											<button class="cf7md-scg--copy-btn mdc-button mdc-button--dense" data-mdc-auto-init="MDCRipple"><?php _e( 'Copy', 'material-design-for-contact-form-7' ); ?></button>
											<button class="cf7md-scg--insert-btn mdc-button mdc-button--raised mdc-button--primary mdc-button--dense" data-mdc-auto-init="MDCRipple"><?php _e( 'Insert', 'material-design-for-contact-form-7' ); ?></button>
										</div>
									</div>
								</div>
							<?php endforeach; ?>
    ...
    private function get_pro_ad_html() {
		...
		<div class="cf7md-admin">
			<div id="cf7md-pro-admin" class="mdc-card">
				<a href="#" class="notice-dismiss"><span class="screen-reader-text"><?php _e( 'Close', 'material-design-for-contact-form-7' ); ?></span></a>
				<div class="cf7md-card--img-left">
					<div class="cf7md-pro-admin-slideshow">
						...
						<img data-about="icons" src="<?php echo $this->plugin_url; ?>assets/images/admin-slide-icons.png" alt="Icons">
				...
				<div class="cf7md-card--body-right">
					<h2 class="cf7md-card-title"><?php /* translators: %s: "Material Design". Please match character count */ printf( __( 'Upgrade to %s Pro', 'material-design-for-contact-form-7' ), 'Material Design' ); ?></h2>
					<div class="cf7md-card-content">
						<ul>
							...
							<li class="li-for-styles">
								...
								<a href="<?php echo $this->customize_url; ?>" target="_blank"><?php _e( 'Try it for free', 'material-design-for-contact-form-7' ); ?></a>.
							</li>
					...
					<div class="cf7md-card-actions">
						<a href="<?php echo $this->upgrade_url; ?>" class="cf7md-button"><?php /* translators: %s: price */ printf( __( 'Upgrade for %s', 'material-design-for-contact-form-7' ), $this->upgrade_cost ); ?></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="cf7md-admin">
			<div id="cf7md-instructions-metabox" class="mdc-card" style="margin-bottom: 24px;">
				...
				<div class="cf7md-card-body">
					<p><?php /* translators: %1$s and %2$s: "Material Design" */ printf( __( 'Apply %1$s to your form using shortcodes which you can generate with the "%2$s" button. Your form should look something like this:', 'material-design-for-contact-form-7' ), 'material design', 'Material Design' ); ?></p>
					<pre>[md-form]

[md-text label="<?php _e( 'Your name', 'material-design-for-contact-form-7' ); ?>"]
[text* your-name]
[/md-text]

[md-text label="<?php _e( 'Your email', 'material-design-for-contact-form-7' ); ?>"]
[email* your-email]
[/md-text]

[md-textarea label="<?php _e( 'Your message', 'material-design-for-contact-form-7' ); ?>"]
[textarea* your-message]
[/md-textarea]

[md-submit]
[submit "<?php _e( 'Send', 'material-design-for-contact-form-7' ); ?>"]
[/md-submit]

[/md-form]</pre>
				<ul>
					<li><a href="#" class="cf7md-open-docs"><?php _e( 'Documentation', 'material-design-for-contact-form-7' ); ?></a></li>
					<li><a href="<?php echo $this->demos_url; ?>" target="_blank"><?php _e( 'Demos', 'material-design-for-contact-form-7' ); ?></a></li>
					<li><a href="https://wordpress.org/support/plugin/material-design-for-contact-form-7/reviews/?rate=5#new-post" target="_blank"><?php _e( 'Rate this plugin', 'material-design-for-contact-form-7' ); ?></a></li>
					<?php if( $this->fs->is_free_plan() ) : ?>
						<li><a href="https://wordpress.org/support/plugin/material-design-for-contact-form-7/" target="_blank"><?php _e( 'Support', 'material-design-for-contact-form-7' ); ?></a></li>
						<li><a href="<?php echo $this->customize_url; ?>"><?php _e( 'Try the style customizer', 'material-design-for-contact-form-7' ); ?></a> (<?php _e( 'pro feature', 'material-design-for-contact-form-7' ); ?>)</li>
					...
					<?php else: ?>
						<li><a href="mailto:cf7materialdesign@gmail.com" target="_blank"><?php _e( 'Direct email support', 'material-design-for-contact-form-7' ); ?></a></li>
						<li><a href="<?php echo $this->customize_url; ?>"><?php _e( 'Customize styles', 'material-design-for-contact-form-7' ); ?></a></li>
					<?php endif; ?>
					<?php if( ! $this->live_preview_plugin_active ) : ?>
						<li><a href="<?php echo esc_attr( $this->live_preview_url ); ?>" target="_blank"><?php _e( 'Get the CF7 Live Preview plugin', 'material-design-for-contact-form-7' ); ?></a></li>
					<?php endif; ?>
				...
				<table class="cf7md-table">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<?php echo $outlined_attr; ?><hr />
								<?php echo $label_attr; ?><hr />
								<?php echo $icon_attr; ?><hr />
						...
						<tr class="cf7md-pro-sc">
							...
							<td>Wraps checkbox form tags to turn them into <a href="https://material.io/guidelines/components/selection-controls.html#selection-controls-switch" target="_blank">switches</a>. <?php echo $pro_feature_link; ?></td>
							<td>
								<?php echo $label_attr; ?><hr />
								<?php echo $display_attr; ?><hr />
								<?php echo $help_attr; ?><hr />
...
[/md-submit]</pre>
    ...
    public function md_help_tab() {
		...
		if (
			$screen->base != 'toplevel_page_wpcf7' &&
			$screen->base != 'contact_page_wpcf7-new' &&
			$screen->base != 'contact-2_page_wpcf7-new'
		)
            return;
