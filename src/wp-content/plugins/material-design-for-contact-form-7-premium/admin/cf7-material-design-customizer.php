...
class CF7_Material_Design_Customizer {
    ...
    public function previewer_scripts() {
        ...
        wp_register_script( 'cf7-material-design-customizer', plugins_url( '../assets/js/cf7-material-design-customizer.js', __FILE__ ), array( 'jquery' ), '1.0', true );
        ...
        wp_enqueue_script( 'cf7-material-design-customizer-preview', plugins_url( '../assets/js/cf7-material-design-customizer-preview.js', __FILE__ ), array( 'jquery' ), '1.0', true );
    ...
    public function control_scripts() {
        ...
        // Customizer preview
        wp_enqueue_script( 'cf7-material-design-customizer-control', plugins_url( '../assets/js/cf7-material-design-customizer-control.js', __FILE__ ), array( 'jquery' ), '1.0', true );
    ...
    public function customize_register( $wp_customize ) {
        ...
        $wp_customize->add_section( 'cf7md_options', array(
            'title' => /* translators: %s: "Material Design" */ sprintf( __( '%s Forms', 'material-design-for-contact-form-7' ), 'Material Design' ),
            'description' => /* translators: %s: "Material Design" */ sprintf( __('Customize your %s forms', 'material-design-for-contact-form-7' ), 'Material Design' ),
            'priority' => 160,
        ...
        $checkbox_control = array(
            ...
            'description' => /* translators: %s: hyperlink */ sprintf( __( "Note: you're on the free version. Your style changes will not take effect until you %s upgrade to pro%s", 'material-design-for-contact-form-7' ), '<a href="' . $this->upgrade_url . '">', '</a>' )
        );
        if( $this->fs->is__premium_only() ) {
			if( $this->fs->can_use_premium_code() ) {
                $checkbox_control['description'] = '';
            }
        }
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( 
            $wp_customize, 
            'cf7md_options[primary_on_light]', 
            array(
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( 
            $wp_customize, 
            'cf7md_options[button_hover_on_light]', 
            array(
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( 
            $wp_customize, 
            'cf7md_options[button_hover_on_dark]', 
            array(
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( 
            $wp_customize, 
            'cf7md_options[btn_text_dark_theme]', 
            array(
        ...
        $available_fonts = array( '"Roboto", sans-serif' => 'Roboto (material design default)') + $available_fonts;
		...
		if( class_exists('WP_Customize_Code_Editor_Control') ) {
			$wp_customize->add_control( new WP_Customize_Code_Editor_Control( $wp_customize, 'cf7md_options[custom_css]', array(
				...
				'section'         => 'cf7md_options',
				'code_type'       => 'text/css',
				'editor_settings' => array('codemirror' => array(
					'gutters'     => array(),
					'lineNumbers' => false
				)),
				'input_attrs'     => array(
