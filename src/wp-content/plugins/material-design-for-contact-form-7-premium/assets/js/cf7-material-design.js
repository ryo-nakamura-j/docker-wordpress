...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $('.cf7md-form').each(function () {
      ...
      $this.siblings('p').add($this.find('p')).filter(function () {
    ...
    $('.cf7md-checkbox, .cf7md-radio').each(function () {
      ...
      $items.each(function () {
        ...
        $wrap.append($html);
        $wrap.after('<label class="cf7md-' + type + '-label" for="' + id + '">' + label + '</label>'); // Instantiate mdc checkbox js
    ...
    $('.cf7md-switch').each(function () {
      ...
      $items.each(function () {
        var $item = $(this),
            ...
            id = 'cf7md' + ++cf7mdId,
            $newlabel = $('<label for="' + id + '" class="cf7md-switch-label">' + label + '</label>'); // Add classes and ID
    ...
    function toggleSubmit($form) {
      ...
      if ($form.find('.cf7md-accept').hasClass('cf7md-is-wpcf7v5')) {
        ...
        $acceptances.each(function (i, node) {
          ...
          if ($this.hasClass('wpcf7-invert') && $this.is(':checked') || !$this.hasClass('wpcf7-invert') && !$this.is(':checked')) {
            $submit.attr('disabled', 'disabled');
          }
        });
      }
    ...
    $('.cf7md-submit').each(function () {
      ...
      $inputs.each(function () {
        ...
        $btn.addClass('cf7md-submit-btn mdc-button mdc-button--raised mdc-button--primary mdc-ripple-surface'); // Replace input with button
