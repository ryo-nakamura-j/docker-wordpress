...
class CF7_Material_Design {
	...
	public function add_scripts_and_styles() {
		...
		wp_enqueue_script( 'cf7-material-design', plugins_url( '../assets/js/cf7-material-design.js', __FILE__ ), array( 'jquery', 'md-components-js', 'autosize' ), '1.1', true );
		...
		wp_enqueue_style( 'cf7-material-design', plugins_url( '../assets/css/cf7-material-design.css', __FILE__ ), array(), '2.0' );
			...
			<div class="mdc-layout-grid">
				...
				<?php if( ! get_transient( 'cf7md_customize_link_closed' ) && current_user_can( 'install_plugins' ) && ! is_customize_preview() ) : ?>
					<div class="cf7md-admin-customize-message">
						<p>
							<a href="<?php echo $customize_url; ?>" title="Only admins can see this message">Customize your form's colours and fonts</a>
				...
				<div class="mdc-card">
					<?php if( $title || $subtitle ) : ?>
						<section class="mdc-card__primary">
							<?php if( $title ) : ?>
								<h3 class="mdc-card__title mdc-card__title--<?php echo esc_attr( $titlesize ); ?>"><?php echo wp_kses_post( $title ); ?></h3>
							<?php endif; ?>
							<?php if( $subtitle ) : ?>
								<p class="mdc-card__subtitle"><?php echo wp_kses_post( $subtitle ); ?></p>
							<?php endif; ?>
						</section>
					<?php endif; ?>
		...
		<div class="cf7md-item cf7md-text <?php echo esc_attr( $layout_classes ); ?>">
			...
			<div style="display: none;" class="cf7md-text-html">
				<div class="mdc-textfield" data-mdc-auto-init="MDCTextfield">
					<label class="mdc-textfield__label"><?php echo wp_kses_post( $label ); ?></label>
				</div>
			</div>
		</div>
		<?php            
	...
	public function md_select_shortcode( $atts, $content = '' ) {
		...
		<div class="<?php echo esc_attr( $class ); ?>">
			<?php echo $content; ?>
			<span style="display: none;" class="cf7md-select-label"><?php echo wp_kses_post( $label ); ?></span>
			<?php $this->do_help( $help ); ?>
		</div>
		<?php            
	...
	public function md_submit_shortcode( $atts, $content = '' ) {
		...
		?>
		<div class="cf7md-item cf7md-submit <?php echo esc_attr( $layout_classes ); ?>">
			<?php echo $content; ?>
