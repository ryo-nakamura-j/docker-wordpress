...
(function ($) {
    ...
    const WPPopupsBuilder = {
        ...
        ready: function () {
            ...
            elements.$noFieldsPreview    = $( '.wppopups-no-fields-holder .no-fields-preview' );
            ...
            WPPopupsBuilder.fieldChoiceSortable( 'checkbox' );
        ...
        bindUIActions: function () {
            ...
            // Fields Panel
            WPPopupsBuilder.bindUIActionsFields();
        ...
        bindUIActionsContent: function () {
            ...
            if (typeof window.parent.tinymce !== 'undefined' &&
                window.parent.tinymce.EditorManager.editors !== 'undefined' ) {
                const editors = window.parent.tinymce.EditorManager.editors;
                for (const e in editors) {
                    let editor = editors[e];
                    if (editor.id != 'wppopups_panel_field_content_popup_content'
                        && editor.id != 'wppopups_panel_field_bottom_content_bottom_content'
                    ) {
                        continue;
                    }
                    editor.on(
        ...
        updateEditorContent: function(editor) {
            const fields_container = $('.spu-content').find('.wppopups-field-container');
        ...
        bindUIActionsSettings: function () {
            ...
            $builder.on(
                'click', '.wppopups-panel:not(#wppopups-panel-optin) .wppopups-submit-button', function (e) {
                    e.preventDefault();
            });

            $builder.on(
                'click', '#wppopups-panel-optin .wppopups-submit-button', function (e) {
                    e.preventDefault();
        ...
        rulesClone: function (el, cloning) {
            ...
            const $this = $(el),
                $container_groups = $this.closest('div.wppopups-container-rules'),
                input = $container_groups.attr( 'data-input' );
            ...
            $new_row.find('[name]').each(function () {
                ...
                $(this).attr('name', $(this).attr('name').replace('clone_rules', input));
                // update ids
        ...
        bindUIActionsFields: function() {
            ...
            $builder.on('click', '.wppopups-field-duplicate', function(e) {
                e.preventDefault();
                WPPopupsBuilder.fieldDuplicate($(this).parent());
                //WPPopupsBuilder.fieldDuplicate($(this).parent().data('field-id'));
            });
            ...
            $builder.on(
                'change',
                '.wppopups-field-option-row-limit_enabled input',
                function( event ) {
                        ...
                        confirm: {
                            ...
                            action: function(){
                                var $newField            = $field.clone(),
                                    ...
                                    regex_elementID      = new RegExp( '\\b(id|for)="wppopups-(.*?)'+id+'(.*?)"', "ig");
                                ...
                                var $newFieldOptions = $('.wppopups-field-options #wppopups-field-option-'+newFieldID);
                                ...
                                $builder.trigger('wppopupsFieldAdd', [newFieldID, type]);

                                // Lastly, update the next ID stored in database
                                $.post(wppopups_builder_vars.ajax_url, {form_id : s.formID, nonce : wppopups_builder_vars.nonce, action : 'wppopups_builder_increase_next_field_id'});
                            }
                        },
                        cancel: {
                            text: wppopups_builder_vars.cancel
        ...
        fieldAdd: function(type, options) {
            ...
            return $.post(wppopups_builder_vars.ajax_url, data, function(res) {
                if (res.success) {
                    ...
                    const totalFields = $('#wppopups-panel-optin .wppopups-field').length,
        ...
        fieldSortable: function() {
            ...
            let fieldOptions = $('#wppopups-panel-optin .wppopups-field-options'),
                fieldReceived = false,
                fieldIndex,
                fieldIndexNew,
                field,
            ...
            $('#wppopups-panel-optin .wppopups-field-wrap').sortable({
                ...
                receive: function(e, ui) {
                    ...
                    WPPopupsBuilder.fieldAdd(type, {position: pos, placeholder: $el});
                }
            });

            $( '.wppopups-add-fields-button' )
                .not( '.not-draggable' )
                .not( '.upgrade-modal' )
                .not( '.warning-modal' )
                .not( '.education-modal' )
