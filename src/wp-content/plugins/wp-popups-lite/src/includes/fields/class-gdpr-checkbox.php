 ...
 * @since 1.4.6
 */
class WPPopups_Field_GDPR_Checkbox extends WPPopups_Field {
	...
	public function init() {
		...
		$this->name     = esc_html__( 'GDPR Agreement', 'wp-popups-lite' );
		$this->type     = 'gdpr-checkbox';
		$this->icon     = 'fa-check-square-o';
		$this->order    = 500;
		$this->defaults = array(
			1 => array(
				'label'   => esc_html__( 'I consent to having this website store my submitted information so they can respond to my inquiry.', 'wp-popups-lite' ),
				'value'   => '',
				'image'   => '',
				'default' => '',
			),
		...
		add_filter( 'wppopups_field_new_required', array( $this, 'field_default_required' ), 10, 2 );

		// Define additional field properties.
		add_filter( 'wppopups_field_properties_gdpr-checkbox', array( $this, 'field_properties' ), 5, 3 );
	}
	...
	public function field_options( $field ) {
		...
		$this->field_option(
			...
			$field,
			array(
				'label' => esc_html__( 'Agreement', 'wp-popups-lite' ),
			)
		);
...
new WPPopups_Field_GDPR_Checkbox();
